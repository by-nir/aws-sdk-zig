...
pub const ServiceExtensionHook = gen_service.ServiceExtensionHook;
pub const ServiceExtension = gen_service.ServiceExtension;
...
pub const ClientSendSyncFuncHook = gen_client.ClientSendSyncFuncHook;
